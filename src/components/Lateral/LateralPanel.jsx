...
export function LateralPanel(){
    ...
    return (
        <div className='w-[22%] shadow-black shadow-lg min-h-[97vh] rounded-xl z-50 backdrop-blur-xl flex flex-col p-1 bg-gradient-to-br from-slate-50 to-slate-100'> {/*Panel lateral */}

            <div className="grid grid-cols-5 gap-1 p-1"> {/*HEADER GRID 5 */}
                        <div className="rounded-xl col-span-1 h-[3.5rem] flex items-center justify-center hover:hover:cursor-pointer hover:bg-green-200 p-1" onClick={() => setNum(1)}>
                        ...
                        <div className="rounded-xl col-span-1 h-[3.5rem] flex items-center justify-center  hover:hover:cursor-pointer hover:bg-green-200" onClick={() => setNum(5)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#1c1c1c" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-settings-icon lucide-settings"><path d="M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915"/><circle cx="12" cy="12" r="3"/></svg>
